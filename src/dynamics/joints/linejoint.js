...
goog.provide('box2d.dynamics.joints.LineJoint');
...
/**
 * @param {!box2d.dynamics.joints.LineJointDef} def
 * @constructor
 * @extends {box2d.dynamics.joints.Joint}
 */
box2d.dynamics.joints.LineJoint = function(def) {
    goog.base(this, def);
    ...
    this.m_K = new box2d.common.math.Mat22();
...
goog.inherits(box2d.dynamics.joints.LineJoint, box2d.dynamics.joints.Joint);

box2d.dynamics.joints.LineJoint.prototype.getAnchorA = function() {
    return this.m_bodyA.getWorldPoint(this.m_localAnchor1);
};

box2d.dynamics.joints.LineJoint.prototype.getAnchorB = function() {
    return this.m_bodyB.getWorldPoint(this.m_localAnchor2);
};

box2d.dynamics.joints.LineJoint.prototype.getReactionForce = function(inv_dt) {
    if (inv_dt === undefined) inv_dt = 0;
    return box2d.common.math.Vec2.get(inv_dt * (this.m_impulse.x * this.m_perp.x + (this.m_motorImpulse + this.m_impulse.y) * this.m_axis.x), inv_dt * (this.m_impulse.x * this.m_perp.y + (this.m_motorImpulse + this.m_impulse.y) * this.m_axis.y));
};

box2d.dynamics.joints.LineJoint.prototype.getReactionTorque = function(inv_dt) {
    if (inv_dt === undefined) inv_dt = 0;
    return inv_dt * this.m_impulse.y;
};

box2d.dynamics.joints.LineJoint.prototype.getJointTranslation = function() {
    var bA = this.m_bodyA;
    var bB = this.m_bodyB;
    var tMat;
...
box2d.dynamics.joints.LineJoint.prototype.getJointSpeed = function() {
    var bA = this.m_bodyA;
    var bB = this.m_bodyB;
    var tMat;
    tMat = bA.m_xf.R;
...
box2d.dynamics.joints.LineJoint.prototype.isLimitEnabled = function() {
    return this.m_enableLimit;
};

box2d.dynamics.joints.LineJoint.prototype.enableLimit = function(flag) {
    this.m_bodyA.setAwake(true);
    this.m_bodyB.setAwake(true);
    this.m_enableLimit = flag;
};

box2d.dynamics.joints.LineJoint.prototype.getLowerLimit = function() {
    return this.m_lowerTranslation;
};

box2d.dynamics.joints.LineJoint.prototype.getUpperLimit = function() {
    return this.m_upperTranslation;
};

box2d.dynamics.joints.LineJoint.prototype.setLimits = function(lower, upper) {
...
box2d.dynamics.joints.LineJoint.prototype.isMotorEnabled = function() {
    return this.m_enableMotor;
};

box2d.dynamics.joints.LineJoint.prototype.enableMotor = function(flag) {
    this.m_bodyA.setAwake(true);
    this.m_bodyB.setAwake(true);
    this.m_enableMotor = flag;
};

box2d.dynamics.joints.LineJoint.prototype.setMotorSpeed = function(speed) {
...
box2d.dynamics.joints.LineJoint.prototype.getMotorSpeed = function() {
    return this.m_motorSpeed;
};

box2d.dynamics.joints.LineJoint.prototype.setMaxMotorForce = function(force) {
...
box2d.dynamics.joints.LineJoint.prototype.getMaxMotorForce = function() {
    return this.m_maxMotorForce;
};

box2d.dynamics.joints.LineJoint.prototype.getMotorForce = function() {
    return this.m_motorImpulse;
};

box2d.dynamics.joints.LineJoint.prototype.initVelocityConstraints = function(step) {
    var bA = this.m_bodyA;
    var bB = this.m_bodyB;
    var tMat;
    var tX = 0;
    ...
    this.m_axis.setV(box2d.common.math.Math.mulMV(xf1.R, this.m_localXAxis1));
    this.m_a1 = (dX + r1X) * this.m_axis.y - (dY + r1Y) * this.m_axis.x;
    this.m_a2 = r2X * this.m_axis.y - r2Y * this.m_axis.x;
    this.m_motorMass = this.m_invMassA + this.m_invMassB + this.m_invIA * this.m_a1 * this.m_a1 + this.m_invIB * this.m_a2 * this.m_a2;
    this.m_motorMass = this.m_motorMass > Number.MIN_VALUE ? 1.0 / this.m_motorMass : 0.0;

    this.m_perp.setV(box2d.common.math.Math.mulMV(xf1.R, this.m_localYAxis1));
...
box2d.dynamics.joints.LineJoint.prototype.solveVelocityConstraints = function(step) {
    var bA = this.m_bodyA;
    var bB = this.m_bodyB;
    var v1 = bA.m_linearVelocity;
    var w1 = bA.m_angularVelocity;
    ...
    if (this.m_enableLimit && this.m_limitState != box2d.dynamics.joints.Joint.e_inactiveLimit) {
        ...
        var tempOriginVec = box2d.common.math.Vec2.get(0, 0);
        var df = this.m_K.solve(tempOriginVec, (-Cdot1), (-Cdot2));
        box2d.common.math.Vec2.free(tempOriginVec);
        ...
        box2d.common.math.Vec2.free(f1);
...
box2d.dynamics.joints.LineJoint.prototype.solvePositionConstraints = function(baumgarte) {
    ...
    this.m_s1 = (dX + r1X) * this.m_perp.y - (dY + r1Y) * this.m_perp.x;
    this.m_s2 = r2X * this.m_perp.y - r2Y * this.m_perp.x;
    var impulse = box2d.common.math.Vec2.get(0, 0);
