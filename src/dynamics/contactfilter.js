...
goog.provide('box2d.dynamics.ContactFilter');
 ...
 */
box2d.dynamics.ContactFilter = function() {
    UsageTracker.get('box2d.dynamics.ContactFilter').trackCreate();
};
 ...
 * @return {boolean}
 */
box2d.dynamics.ContactFilter.prototype.shouldCollide = function(fixtureA, fixtureB) {
